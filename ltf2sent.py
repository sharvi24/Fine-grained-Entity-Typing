...
def ltf2sent(ltf_str):
    ...
    #             t_text = ''
    #         # get token bio tag
    #         #sent_res.append([t_text, doc_id, start_char, end_char])
    #         sent_res.append(t_text)
    #     all_sents.append(' '.join(sent_res))
    #     #all_sents.append(sent_res)
...
def load_ltf(ltf_str):
    ...
    for seg in root.find('DOC').find('TEXT').findall('SEG'):
        ...
        doc_tokens.append([doc_id, seg_text, seg_start, seg_end])
